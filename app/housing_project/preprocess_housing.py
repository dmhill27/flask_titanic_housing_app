...
class PreProcess_Housing():
  ...
  def impute(self, num_cols_impute, cat_cols_impute, imputer_median, imputer_mode):
    ...
    # change feature types to string
  ...
  # assign bin values to YrSold, MoSold, YearBuilt, GarageYrBuilt
  ...
  # create feature combinations and binary features from numerical features
  ...
  # use encoder to create one_hot_encoded features from categorical features
  ...
  # create polynomial features from numerical features
